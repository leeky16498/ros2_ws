...
class LEDPanelNode(Node): 
    def __init__(self):
        ...
        self.led_states_pub_ = self.create_publisher(LedStateArray, "led_panel_state", 10) # 퍼블리셔
        self.timer_ = self.create_timer(2.0, self.publish_led_states) # 타이머
        self.get_logger().info("LED panel node has been started!") # 로그 체크
